...
List<Question> questions = [
  ...
  Question(
    ...
    ["Kompilasyon, optimizasyon, paketleme", "Debug, test, deploy", "Build, run, analyze", "Code, compile, execute"],
    "Debug, test, deploy",
  ...
  Question(
    ...
    ["Sunucu tabanlı işlemler", "İstemci tabanlı işlemler", "Dosya tabanlı işlevler", "Veri tabanlı işlevler"],
  ...
  Question(
    ...
    ["Vesikalık", "Selfie", "Arkadaşları ile fotoğraf çekinirken habersiz bir poz:)", "pasaport fotoğrafı"],
